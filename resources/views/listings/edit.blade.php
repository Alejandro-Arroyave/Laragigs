  ...
  <div class="mx-4">
    <x-card class="p-10 max-w-lg mx-auto mt-24">
      ...
      <form method="POST" action="/listings/{{ $listing->id }}"
        ...
        @method('PUT')
        <div class="mb-6">
          <label for="company" class="inline-block text-lg mb-2">Company
            Name</label>
          <input type="text"
        ...
        <div class="mb-6">
          <label for="title" class="inline-block text-lg mb-2">Job
            Title</label>
          <input type="text"
        ...
        <div class="mb-6">
          <label for="location" class="inline-block text-lg mb-2">Job
            Location</label>
          <input type="text"
        ...
        <div class="mb-6">
          <label for="email" class="inline-block text-lg mb-2">Contact
            Email</label>
          <input type="text"
        ...
        <div class="mb-6">
          ...
          <input type="file"
            class="border border-gray-200 rounded p-2 w-full" name="logo" />
